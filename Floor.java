 ...
 *  for rectangular rooms. To calculate the price, you multiply the area of the floor 
 *  (width times length) by the price per square meter of carpet. For example, the area of the 
 *  floor that is 12 meters long and 10 meters wide is 120 square meters. To cover the floor with
...
2.Write a class with the name Carpet. The class needs one field (instance variable) with name cost 
of type double.
