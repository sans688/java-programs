...
and it needs to initialize the fields. In case the width is less than 0 it needs to set the width
field value to 0, in case the height parameter is less than 0 it needs to set the height field value to 0.  
...
Method named setHeight with one parameter of type double, it needs to set the value of the heigfield. 
